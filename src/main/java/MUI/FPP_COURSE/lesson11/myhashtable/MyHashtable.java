package MUI.FPP_COURSE.lesson11.myhashtable;
...
//		System.out.println(h);
	...
	/** 
	 * The iterator for linked lists in the table uses Entry objects.
	 * The following returns an iterator that cycles through just the keys.
	 */
	...
	private int hash(int hashcode) {
		return (int) Math.abs(hashcode % tableSize);
	}
