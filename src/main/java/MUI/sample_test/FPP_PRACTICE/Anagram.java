...
//	{'b', 'i', 'g'} and {'b', 'i', 'g'} 1
    ...
    static int areAnagrams(char[] a1, char[] a2) {
       ...
       int[] countLetter = new int[256];
        ...
        // Si todas las cuentas son cero, es un anagrama
    ...
    static void anagramTest() {
        System.out.println(areAnagrams(new char[]{'s', 'i', 't'}, new char[]{'i', 't', 's'})); // 1
        System.out.println(areAnagrams(new char[]{'s', 'i', 't'}, new char[]{'i', 'd', 's'})); // 0
        System.out.println(areAnagrams(new char[]{'b', 'i', 'g'}, new char[]{'b', 'i', 't'})); // 0
        System.out.println(areAnagrams(new char[]{'b', 'o', 'g'}, new char[]{'b', 'o', 'o'})); // 0
        System.out.println(areAnagrams(new char[]{}, new char[]{})); // 1
        System.out.println(areAnagrams(new char[]{'b', 'i', 'g'}, new char[]{'b', 'i', 'g'})); // 1
    }
